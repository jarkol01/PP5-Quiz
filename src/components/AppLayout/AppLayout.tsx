                ...
                <div>
                  {
                    isAddQuestionDisplayed && categoryID && user ?
                      <AddQuestion key="add-question" categoryID={categoryID}/>
                      : categoryID && user ?
                        <Button key="add-question-button" variant="contained" color="info" sx={{margin: "1rem"}}
                                startIcon={<AddIcon/>} onClick={() => setAddQuestionDisplayed(true)}>Dodaj
                          pytanie</Button>
                        : categoryID && <span>Żeby dodać pytanie musisz się zalogować</span>
                  }
                </div>
              </>
            </QuestionProvider>
